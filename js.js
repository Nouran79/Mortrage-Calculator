...
//mathimatical calculations are made by chatgpt, lel 2mana
...
function Clear(){
document.paym.amount.value=0;
document.paym.term.value=0;
document.paym.rate.value=0;
document.paym.type.value=0;
document.getElementById('amount2').textContent='$';
document.getElementById('amount3').textContent='$';
}